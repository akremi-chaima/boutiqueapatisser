...
class UpdatePasswordController extends AbstractController
{
     ...
     * @OA\Response(response=400, description="The user should be administrator or customer | The account is disabled | Invalid password | The newPasswordConfirmation and newPassword should have the same value")
     *
    ...
    {
        if (!in_array(Role::ROLE_ADMINISTRATOR, $user->getRoles()) && !in_array(Role::ROLE_CUSTOMER, $user->getRoles())) {
            return new JsonResponse(['error_message' => 'The user should be administrator or customer'], Response::HTTP_BAD_REQUEST);
        }
